...
<div class="page-heading">
    ...
    @elseif($kelompok && $kelompok->status == 'pending')
    <div class="alert alert-info">
        Sedang ditinjau koordinator Prakerin. Silahkan tunggu informasi selanjutnya!.
    </div>
    @endif
</div>
...
<div class="page-content">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form-body">
                            ...
                            <div id="anggotaContainer" class="row">
                                ...
                                <div class="col-12">
                                    <button type="button" class="btn btn-secondary mt-2 w-100" id="addAnggotaBtn">Tambah
                                        Anggota</button>
                                </div>
                            </div>
                        </div>
    ...
    <form action="{{ route('siswa.edit-pengajuan', $kelompok->id) }}" method="POST" class="form form-vertical">
        @csrf
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form-body">
                            <h4 class="card-title mb-3">Anggota Kelompok</h4>
                            <div class="row">
                                @foreach($kelompok->anggotaKelompok as $ak)
                                <div class="col-12">
                                    <label for="anggota1">Anggota 1</label>
                                    <div class="form-group mt-2">
                                        <select class="choices form-select" name="anggota[]" id="anggota1">
                                            <option value="{{ $ak->siswa->id }}">{{ $ak->siswa->nama_siswa }}</option>
                                            @foreach($siswaList as $s)
                                            <option value="{{ $s->id }}">{{ $s->nama_siswa }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group mt-2">
                                        <input type="text" class="form-control"
                                            value="{{ $anggota->siswa->nama_siswa }}" readonly>
                                    </div>
                                </div>
                                @endforeach
                            </div>
